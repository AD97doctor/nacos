...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private void loadSetting() {
        try {
            ...
            System.out.println("数据源为 platform ===== " + platform);
...
//          boolean useExternalStorage =  PropertiesConstant.MYSQL.equalsIgnoreCase(platform) || PropertiesConstant.UNVDB.equalsIgnoreCase(platform)
