...
public class ConfigInfoMapperByUnvDb extends AbstractMapper implements ConfigInfoMapper {
    ...
    public String findChangeConfigFetchRows(Map<String, String> params, final Timestamp startTime,
        ...
        return sqlFetchRows + where + " AND id > " + lastMaxId + " ORDER BY id ASC LIMIT " + pageSize;
    }
